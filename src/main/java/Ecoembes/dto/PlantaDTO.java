...
public class PlantaDTO {
    ...
    public Map<LocalDate, Integer> getCapacidadDeterminada() { return capacidadDeterminada; }
    public void setCapacidadDeterminada(Map<LocalDate, Integer> capacidadDeterminada) { this.capacidadDeterminada = capacidadDeterminada; }
}